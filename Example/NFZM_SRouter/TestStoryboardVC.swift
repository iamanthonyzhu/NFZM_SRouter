...
class TestStoryboardVC: UIViewController {
...
extension TestStoryboardVC:RouterProtocol {
...
//    }
    ...
    static public func targetConfigForRouter() -> (action:RouterActionType, vcType:RouterVCType) {
        (RouterActionType.push(true),.rStoryboard(fileName: "TestStoryboardVC", bundlePath: Bundle.main,identifier: "TestStoryboardVCId"))
    }
